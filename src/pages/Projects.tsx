				...
				<div className="container mx-auto px-4">
					<div className="max-w-3xl mx-auto text-center">
						...
						<p className="text-lg text-gray-700 dark:text-gray-300 mb-8 animate-fade-in">
							Explore the innovative projects being developed by our community members. Join us in
							building technology solutions that benefit our community.
						</p>
			...
			<section className="py-16 bg-gray-50 dark:bg-gray-800">
				<div className="container mx-auto px-4 text-center">
					...
					<p className="text-lg text-gray-700 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
						We're always looking for innovative project ideas to support our community's growth. If
						you have an idea for a project, we'd love to hear from you!
					</p>
					<SuggestProjectForm
						trigger={
							<Button className="bg-tekOrange hover:bg-orange-600 text-white">
