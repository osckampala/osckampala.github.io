...
const EventCard: React.FC<EventCardProps> = ({ 
  ...
  return (
    <div className={`rounded-xl overflow-hidden bg-white dark:bg-gray-800 shadow-md hover:shadow-lg transition-shadow duration-300 ${className}`}>
      ...
      <div className="p-5">
        ...
        {!showContent && (
          <Button variant="outline" className="border-tekOrange text-tekOrange hover:bg-tekOrange hover:text-white transition-colors dark:text-orange-300 dark:hover:text-white">
